...
export default function Designs(props){
    ...
    const categs=['AVI','Concept Logo','Banner','Header','Wallpaper','Profile Picture','Logo Design','Drip Logo','Thumbnail'];
    const styleID=['','','long','long','long','','','','long'];
    const [activeIndex, setActiveIndex] = useState(0);
    const [inScroll,setInScroll]=useState(true);
    
    
    const refs = [useRef(null),useRef(null),useRef(null),useRef(null),useRef(null),useRef(null),useRef(null),useRef(null),useRef(null)]
